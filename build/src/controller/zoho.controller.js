...
exports.sendMailWithAccessToken =
  exports.companyTrainningController =
  exports.brochureController =
  exports.privateClassController =
  exports.hireTalentController =
...
exports.contactUsController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
...
exports.hireTalentController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    const {
      jobTitle,
      jobDescription,
...
exports.privateClassController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    const {
      firstName,
      currentRole,
...
exports.brochureController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
...
exports.companyTrainningController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    const {
      email,
      course,
