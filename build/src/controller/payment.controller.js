...
exports.updateUserPayment =
  exports.addUserPayment =
  exports.getPaymentByIdController =
  exports.deleteAllPaymentsController =
  exports.makeSecondPayment =
  exports.amountPaidStatus =
...
exports.getAllPayments = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
...
exports.initializePayment = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
      ...
      let coupon;
      if (couponCode) {
        coupon = await (0, coupon_model_1.getCouponByCouponCodeModel)(
          couponCode,
        );
        if (coupon) {
...
exports.updatePaymentInfo = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
      ...
      if (payment.payment_info.coupon.couponCode) {
        const coupon = await (0, coupon_model_1.getCouponByCouponCodeModel)(
      ...
      const userExist = await (0, user_model_1.getUserByEmailModel)(
        payment.payment_info.email,
      );
      if (!userExist) {
        const userData = {
...
exports.amountPaidStatus = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
      const { paymentId } = req.params;
      ...
      const paymentEntry = payment.payment_info.amountPaid.find(
        (entry) => entry.reference_id === reference_id,
      );
      if (!paymentEntry) {
        return next(
          new ErrorHandler_1.default(
      ...
      if (!payment.payment_info.accountCreated) {
        ...
        try {
          const createAccount = await (0, user_controller_1.registerUserFunc)({
            ...userData,
          });
...
exports.makeSecondPayment = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
      const { paymentId } = req.params;
      ...
      await (0, payment_model_1.updatePaymentModel)(paymentId, payment);
      if (fullyPaid) {
        const user = await (0, user_model_1.getUserByEmailModel)(
          payment.payment_info.email,
        );
        if (user) {
...
exports.deleteAllPaymentsController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
...
exports.getPaymentByIdController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
      const { paymentId } = req.params;
...
const addUserPayment = async ({
  ...
  try {
    ...
    const paymentCreated = await (0, payment_model_1.createPaymentModel)(
      paymentData,
    );
...
const updateUserPayment = async ({
  ...
  try {
    ...
    const payment = await payment_model_2.default.findOne({
