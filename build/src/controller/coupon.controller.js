...
exports.deleteAllCouponController =
  exports.deleteCouponController =
  exports.validateCouponController =
  exports.createBulkCouponController =
  exports.getCouponByCouponCodeController =
  exports.getCouponByIdController =
  exports.getAllCouponController =
    void 0;
...
exports.getAllCouponController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
...
exports.getCouponByIdController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
...
exports.getCouponByCouponCodeController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
...
exports.createBulkCouponController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
      ...
      const couponCodes = Array.from({ length: quantity }, () =>
        (0, generate_coupon_code_1.generateCouponCode)().toUpperCase(),
      );
...
exports.validateCouponController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
      const { couponCode } = req.params;
      if (!couponCode) {
      ...
      let coupon = await (0, coupon_model_1.getCouponByCouponCodeModel)(
        couponCode,
      );
      if (!coupon) {
        return res.status(400).json({
...
exports.deleteCouponController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
      const { couponId } = req.params;
...
exports.deleteAllCouponController = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
