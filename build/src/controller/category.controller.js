...
exports.createCategory = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
      const { name } = req.body;
...
exports.deleteCategory = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
      ...
      await course_model_1.default.updateMany(
...
exports.addCategoryToCourse = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
      ...
      const course = await course_model_1.default.findByIdAndUpdate(
        courseId,
        { categories: category.name },
...
exports.getAllCategories = (0, catchAsynchError_1.default)(
  async (req, res, next) => {
    try {
