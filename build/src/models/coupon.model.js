...
exports.deleteAllCouponModel = exports.deleteCouponModel = exports.updateCouponStatusModel = exports.createCouponModel = exports.getCouponByCouponCodeModel = exports.getCouponByIdModel = exports.getAllCouponModel = exports.couponModel = void 0;
...
const updateCouponStatusModel = async (code, status) => {
    return exports.couponModel.findOneAndUpdate({ code }, // Use the code to find the coupon
    { status }, { new: true });
};
