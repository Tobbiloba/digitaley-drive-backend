...
exports.deleteAllProgress = exports.updateContentProgress = exports.resetProgress = exports.deleteProgress = exports.updateProgress = exports.createProgress = exports.getProgressByContentAndUserId = exports.getProgressByContentId = exports.getProgressByUserId = exports.getProgressBycontentId = exports.getProgressById = exports.getAllProgress = void 0;
...
const resetProgress = async (contentId, userId) => {
    return await ProgressModel.findOneAndUpdate({ contentId, userId }, { progress: 0, completed: false, contentProgress: [] }, { new: true });
};
exports.resetProgress = resetProgress;
const updateContentProgress = async (contentId, userId, subContentId, viewed) => {
    return await ProgressModel.findOneAndUpdate({ contentId, userId, 'contentProgress.subContentId': subContentId }, {
        $set: {
