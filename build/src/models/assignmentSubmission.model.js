...
exports.deleteAllAssignmentSubmissionsModel =
  exports.deleteAssignmentSubmissionModel =
  exports.updateAssignmentSubmissionModel =
  exports.markAssignmentSubmissionModel =
  exports.createAssignmentSubmissionModel =
  exports.getAssignmentSubmissionByIdModel =
  exports.getAllAssignmentSubmissionsModel =
  exports.assignmentSubmissionModel =
    void 0;
...
exports.assignmentSubmissionModel = mongoose_1.default.model(
...
const markAssignmentSubmissionModel = async (submissionId, score) => {
  return exports.assignmentSubmissionModel.findByIdAndUpdate(
    submissionId,
    { score, graded: true },
    { new: true },
  );
