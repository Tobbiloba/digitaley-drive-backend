...
exports.deleteAssignmentQuestionById = exports.updateAssignmentQuestionById = exports.addAssignmentQuestion = exports.deleteQuizQuestionById = exports.updateQuizQuestionById = exports.addQuizQuestion = exports.updateContentInPartModel = exports.deletePartModel = exports.getContentPart = exports.addContentToPartModel = exports.createPartModel = exports.deleteContentById = exports.createContent = exports.getContentByCourseId = exports.getContentById = exports.getAllContents = void 0;
...
const createPartModel = async (contentId, partData) => {
    return await CourseContent.updateOne({ _id: contentId }, { $push: { contentItems: partData } });
};
exports.createPartModel = createPartModel;
const addContentToPartModel = async (contentId, partId, newContent) => {
    return await CourseContent.updateOne({ _id: contentId, 'contentItems._id': partId }, { $set: { 'contentItems.$.contentDetails': newContent } });
};
exports.addContentToPartModel = addContentToPartModel;
const getContentPart = async (contentId, partId) => {
    return await CourseContent.findOne({ _id: contentId, 'contentItems._id': partId }, { 'contentItems.$': 1 });
};
exports.getContentPart = getContentPart;
const deletePartModel = async (contentId, partId) => {
    return await CourseContent.updateOne({ _id: contentId }, { $pull: { contentItems: { _id: partId } } });
};
exports.deletePartModel = deletePartModel;
const updateContentInPartModel = async (contentId, partId, updatedContent) => {
    return await CourseContent.updateOne({ _id: contentId, 'contentItems._id': partId }, {
        $set: {
...
const addQuizQuestion = async (contentId, questionData) => {
    return await CourseContent.updateOne({ _id: contentId }, { $push: { quiz: questionData } });
};
exports.addQuizQuestion = addQuizQuestion;
// Update a single question within the quiz by question ID
const updateQuizQuestionById = async (contentId, questionId, updatedQuestionData) => {
    return await CourseContent.updateOne({ _id: contentId, 'quiz._id': questionId }, { $set: { 'quiz.$': updatedQuestionData } });
};
...
const deleteQuizQuestionById = async (contentId, questionId) => {
    return await CourseContent.updateOne({ _id: contentId }, { $pull: { quiz: { _id: questionId } } });
};
...
const addAssignmentQuestion = async (contentId, questionData) => {
    return await CourseContent.updateOne({ _id: contentId }, { $push: { assignment: questionData } });
};
exports.addAssignmentQuestion = addAssignmentQuestion;
// Update a single question within the assignment by question ID
const updateAssignmentQuestionById = async (contentId, questionId, updatedQuestionData) => {
    return await CourseContent.updateOne({ _id: contentId, 'assignment._id': questionId }, { $set: { 'assignment.$': updatedQuestionData } });
};
...
const deleteAssignmentQuestionById = async (contentId, questionId) => {
    return await CourseContent.updateOne({ _id: contentId }, { $pull: { assignment: { _id: questionId } } });
};
